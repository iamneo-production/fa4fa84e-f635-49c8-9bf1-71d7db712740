...
export class DocumentComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private loan: LoanService, private router: Router, private http: HttpClient ,private notif:ToastrService) {}
...
console.log(this.documentForm.value)
    ...
    this.http.post('https://8080-fbdacabdabafefbfafacdefbeabeacfefaaff.project.examly.io/user/addDocuments', formData, { headers }).subscribe(
      (response) => {
        this.notif.success("Uploaded","Successfully",{timeOut:1000});
        this.showid=true;
        this.doc=false;
