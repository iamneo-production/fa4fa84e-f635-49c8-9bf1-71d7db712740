...
export class CustomerprofileComponent implements OnInit {
  ...
  constructor(private auth:AuthService ,private loanService:LoanService,private fb:FormBuilder,private router:Router ,private notif:ToastrService){
 ...
 onedit(prof:signupForm)
 {
  ...
  ondel(){
    this.loanService.deleteProfile(this.auth.getID()).subscribe((res: any)=>{
      console.log(res);
      this.notif.success('Success',"Account deleted",{timeOut:1000});
